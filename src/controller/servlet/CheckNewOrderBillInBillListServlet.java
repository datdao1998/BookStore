...
@WebServlet(name = "CheckNewOrderBillInBillListServlet")
public class CheckNewOrderBillInBillListServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String t = request.getParameter("length");
        OrderBillService orderBillService = new OrderBillServiceImpl();
        ArrayList<OrderBill> orderBillArrayList = (ArrayList<OrderBill>) orderBillService.getAll();
